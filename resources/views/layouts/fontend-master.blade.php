...
-56z"/>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        @endphp
                        <ul>
                            <li><a href="{{ url('ver/deseo/') }}"><i class="fa fa-heart"></i> <span>{{ count($wishqty) }}</span></a></li>
                            <li><a href="{{ url('ver/carrito/') }}"><i class="fa fa-shopping-bag"></i> <span>{{ $quantity }}</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>S/.{{ $total }}</span></div>
                    </div>
                </div>
...
<section  class="social">
        ...
        <div class="nav-bottom">
            ...
            <img class="social__media--networks-whatsap ancho my-float_mesenger" src="{{ asset('fontend') }}/img/mesenger.gif"
                        alt="mesenger">
            </a>

            <button type="button" id="whats-openPopup" class="whatsapp-button">

                <img class="social__media--networks-whatsap ancho my-float_wasap" src="{{ asset('fontend') }}/img/wasap.gif"  alt="whatsap">
            </button>
